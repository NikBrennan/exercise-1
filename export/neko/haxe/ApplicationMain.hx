...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("exercise-1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("exercise-1", null, 1440, 900);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "exercise-1";
		app.meta["name"] = "exercise-1";
